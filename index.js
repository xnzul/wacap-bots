const XPTN = 'XNZUL BOT V2'; // Nama Bot Whatsapp
const instagram = 'https://instagram.com/r00t_xnzul'; // Nama Instagramlu cok
const nomer = 'https://Wa.me/+6283173142772'; // Nomor whatsapplu cok
const aktif = 'Tergantung jaringan dan donasi'; // Kapan bot lu aktif
const groupwa = 'https://chat.whatsapp.com/D8ViYowjnUXLt7w1VGGuzz'; // OFFICIAL GRUP LU 1
const youtube = 'https://chat.whatsapp.com/D8ViYowjnUXLt7w1VGGuzz'; // OFFICIAL GRUP LU 2
//
...
conn.sendMessage(id, 'waalaikumsalam, Ketik .help/.info/.donasi Contoh #help' ,MessageType.text, { quoted: m });
}
else if (text == 'salam'){
conn.sendMessage(id, 'Waalaikumsalam, Ketik .help/.info/.donasi Contoh #help' ,MessageType.text, { quoted: m });
}
...
conn.sendMessage(id, 'Owner *XNzul-PanutanQur* wa.me/+6283173142772' ,MessageType.text, { quoted: m });
}
...
conn.sendMessage(id, 'Test 1,2,3 ketik .help' ,MessageType.text, { quoted: m });
}
else if (text == 'Hai'){
conn.sendMessage(id, 'Ya?, Ketik .help/.info/.donasi Contoh .help' ,MessageType.text, { quoted: m });
}
...
conn.sendMessage(id, 'love you too' ,MessageType.text, { quoted: m });
}
else if (text == 'Mas'){
conn.sendMessage(id, 'Ya?, Ketik .help/.info/.donasi Contoh .help' ,MessageType.text, { quoted: m });
}
...
conn.sendMessage(id, 'Sama sama, semoga harimu menyenangkan :)' ,MessageType.text, { quoted: m });
}
else if (text == 'Makasi'){
conn.sendMessage(id, 'Sama sama, semoga harimu menyenangkan :)' ,MessageType.text, { quoted: m });
}
...
axios.get(`https://docs-jojo.herokuapp.com/api/mediafire?url=${teks}`).then((res) => {
    let hasil = `${detail}\nFilename : ${filename}`;
    conn.sendMessage(id, hasil ,MessageType.textz, { quoted: m });
})
}
...
conn.sendMessage(id, titoe, MessageType.text, { quoted: m });
})
}
...
conn.sendMessage(id, '*🔥Nih bro fitur / command yang ada di bot ini jika ada bug / yang tidak bisa mohon maaf ya sedang dalam pertahapan, Jika anda bingun silahkan ketil *.readmi* Thanks for use XNZUL BOT🔥*' ,MessageType.text, { quoted: m });
}
//else if (text == '.help'){
//conn.sendMessage(id, 'Thanks Telah Menggunakan BOT *XNZUL BOT V2* , Follow Instagram Mimin Yah😻 : https://instagram.com/@muh_ahsan1999' ,MessageType.text);
//}
...
conn.sendMessage(id, 'Nzul Ganteng Kan :v', MessageType.text, { quoted: m })
}
